<template>
  ...
  <section class="hero flex items-center justify-between p-10 bg-gray-100">
    <div class="hero-content max-w-lg">
      <h1 class="text-5xl font-bold mb-4">Play a game of Recipes keep yourself, entertained and as you dive into the world of recipes</h1>
  ...
  <div class="min-h-screen flex flex-col items-center justify-center bg-gray-50">
    ...
    <!-- Result messages -->
    <p v-if="isCorrect" class="mt-4 text-lg text-green-600">Congratulations! You solved the puzzle!</p>
    <p v-else-if="isChecked && !isCorrect" class="mt-4 text-lg text-red-600">The puzzle isn't correct yet. Keep trying!</p>
  </div>
</template>
...
const originalPieces = Array.from({ length: gridSize * gridSize }, (_, index) => index);
